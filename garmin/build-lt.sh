...
if [ -n "$STYLES" ]; then
    echo "[INFO] using custom STYLES:"
    echo STYLES="$STYLES"
else
    echo "[INFO] using default STYLES:"
    STYLES="generic stranger generic_new rogal"
    echo "STYLES=$STYLES"
fi
